...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					...
					<li><i class="fa fa-phone" aria-hidden="true"></i>+91 8805769620, +919923737916</li>	
					<li class="s-bar">
						<div class="search">
					...
					<ul class="slides">
						<li>
							<div class="w3layouts_work_grid_left">
								...
								<div class="w3layouts_work_grid_left_pos">
									<img src="images/Sharad.png" alt=" " class="img-responsive" />
								</div>
							</div>
							<div class="w3layouts_work_grid_right">
								...
								<p>आलिशान,  सुंदर व भव्य असे हे हॉटेल आहे, आपल्या देशाच्या सुसंस्कृत पुणे ह्या शहरात अशा प्रकारचे आलिशान हॉटेल पाहून मला आनंद झाला.</p>
								<h5>शरदचंद्रजी पवारसाहेब </h5>
								<p>अध्यक्ष,राष्ट्रवादी काँग्रेस पार्टी</p>
							</div>
							<div class="clearfix"> </div>
						</li>
						<li>
							<div class="w3layouts_work_grid_left">
								<img src="images/5.jpg" alt=" " class="img-responsive" />
								<div class="w3layouts_work_grid_left_pos">
									<img src="images/Madhuri.png" alt=" " class="img-responsive" />
								</div>
							</div>
							<div class="w3layouts_work_grid_right">
								<h4>
								...
								<p>It was a amazing hotel in pune city. I am impressed</p>
								<h5>MADHURI DIXIT</h5>
								<p>Actor</p>
							</div>
							<div class="clearfix"> </div>
						...
						<li>
							<div class="w3layouts_work_grid_left">
								<img src="images/5.jpg" alt=" " class="img-responsive" />
								<div class="w3layouts_work_grid_left_pos">
									<img src="images/Hruta.jpg" alt=" " class="img-responsive" />
								</div>
							</div>
							<div class="w3layouts_work_grid_right">
								<h4>
								...
								<p>It is very nice and my favourite hotel in Pune</p>
								<h5>HRUTA DURGULE</h5>
								<p>Actor</p>
							</div>
							<div class="clearfix"> </div>
						...
						<li>
							<div class="w3layouts_work_grid_left">
								<img src="images/5.jpg" alt=" " class="img-responsive" />
								<div class="w3layouts_work_grid_left_pos">
									<img src="images/MSD.jpg" alt=" " class="img-responsive" />
								</div>
							</div>
							<div class="w3layouts_work_grid_right">
								<h4>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+918805769620,+919923737916</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">INFO@SUNRISE.COM</a></p>
			<p class="contact-agile1"><strong>Address :</strong>-JM Corner,Jm Road Shivajinagar,PUNE.</p>
